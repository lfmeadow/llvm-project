...
; RUN: opt --mtriple=amdgpu-amd-amdhsa --data-layout=A5 -S -passes=openmp-opt < %s | FileCheck %s
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    call void @outlined(ptr undef, ptr undef) #[[ATTR1]]
; CHECK-NEXT:    ret void
;
entry:
